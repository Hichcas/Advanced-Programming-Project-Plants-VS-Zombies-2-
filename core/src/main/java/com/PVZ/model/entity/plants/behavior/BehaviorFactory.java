...
import com.PVZ.model.entity.plants.behavior.impl.ProjectileFactory;
...
public final class BehaviorFactory {
    ...
    private static int getIntRuntime(com.PVZ.model.entity.plants.PlantInstance plant, String key, int defaultValue) {
