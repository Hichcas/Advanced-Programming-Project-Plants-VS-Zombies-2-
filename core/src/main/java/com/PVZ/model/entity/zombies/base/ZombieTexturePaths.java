...
public class ZombieTexturePaths {
    ...
    static {
        ...
        PAM_PATHS.put("ZombiePharaohDefault",
            "768/INITIAL/ZOMBIE/ZOMBIE_EGYPT_SARCOPHAGUS/ZOMBIE_EGYPT_SARCOPHAGUS.PAM");
        ...
        PAM_PATHS.put("ZombieTombRaiserDefault",
        ...
        PAM_PATHS.put("ZombieIceageArmor3Default",
            "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_BASIC_BRICK/ZOMBIE_ICEAGE_BASIC_BRICK.PAM");

        PAM_PATHS.put("ZombieIceageBlockheadDefault",
            "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_BASIC_BRICK/ZOMBIE_ICEAGE_BASIC_BRICK.PAM");
        ...
        PAM_PATHS.put("ZombieIceAgeTroglobite",
            "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_TROGLOBITE/ZOMBIE_ICEAGE_TROGLOBITE.PAM");


        PAM_PATHS.put("ZombieWeaselHoarder",
            "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_WEASELHOARDER/ZOMBIE_ICEAGE_WEASELHOARDER.PAM");
        PAM_PATHS.put("ZombieWeaselHoarderDefault",
            "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_WEASELHOARDER/ZOMBIE_ICEAGE_WEASELHOARDER.PAM");
        PAM_PATHS.put("ZombieWeasel", "768/FULL/ZOMBIE/"+
            "ZOMBIE_ICEAGE_WEASEL/ZOMBIE_ICEAGE_WEASEL.PAM");
        PAM_PATHS.put("ZombieWeaselDefault", "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_WEASEL/ZOMBIE_ICEAGE_WEASEL.PAM");
        PAM_PATHS.put("ZombieIceAgeGargantuar",
        ...
        PAM_PATHS.put("ZombieBeachFishermanDefault",
        ...
        PAM_PATHS.put("ZombieDarkGargantuar", "768/FULL/ZOMBIE/DARK_GARGANTUAR/DARK_GARGANTUAR.PAM");
        PAM_PATHS.put("ZombieDarkImpDefault", "768/FULL/ZOMBIE/ZOMBIE_DARK_IMP_MONK/ZOMBIE_DARK_IMP_MONK.PAM");
        ...
        PAM_PATHS.put("ZombieBigHeadAllStarDefault",
            "768/FULL/ZOMBIE/ZOMBIE_BIGHEAD_ALLSTAR/ZOMBIE_BIGHEAD_ALLSTAR.PAM");
        ...
        PAM_PATHS.put("ZombieDarkImpDragonDefault", "768/FULL/"+
            "ZOMBIE/ZOMBIE_DARK_IMP_DRAGON/ZOMBIE_DARK_IMP_DRAGON.PAM");
        PAM_PATHS.put("ZombieImpDragon", "768/FULL/ZOMBIE/ZOMBIE_DARK_IMP_DRAGON/ZOMBIE_DARK_IMP_DRAGON.PAM");
        PAM_PATHS.put("ZombieZombossMechDark", "768/FULL/ZOMBIE/ZOMBIE_DARK_ZOMBOSS/ZOMBIE_DARK_ZOMBOSS.PAM");
        PAM_PATHS.put("ZombieZombossMechBeach", "768/FULL/ZOMBIE/ZOMBIE_BEACH_ZOMBOSS/ZOMBIE_BEACH_ZOMBOSS.PAM");
        PAM_PATHS.put("ZombieZombossMechIceAge", "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_ZOMBOSS/ZOMBIE_ICEAGE_ZOMBOSS.PAM");
        ...
        PAM_PATHS.put("ZombieCrystalSkull", "768/FULL/ZOMBIE/"+
            "ZOMBIE_LOSTCITY_CRYSTALSKULL/ZOMBIE_LOSTCITY_CRYSTALSKULL.PAM");
        PAM_PATHS.put("ZombieCrystalSkullDefault", "768/FULL/ZOMBIE/"+
            "ZOMBIE_LOSTCITY_CRYSTALSKULL/ZOMBIE_LOSTCITY_CRYSTALSKULL.PAM");
        PAM_PATHS.put("ZombieLostCityCrystalSkull", "768/FULL/ZOMBIE/"+
            "ZOMBIE_LOSTCITY_CRYSTALSKULL/ZOMBIE_LOSTCITY_CRYSTALSKULL.PAM");
